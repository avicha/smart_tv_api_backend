...
function sign(str) {
    var abc = md5(eval(function(p, a, c, k, e, r) {
        ...
        while (c--) { if (k[c]) { p = p[_0x9ba7[4]](new RegExp(_0x9ba7[7] + e(c) + _0x9ba7[7], _0x9ba7[8]), k[c]) } };
        return p
    ...
    return (![] + [])[+!+[]] + (+(+!+[] + [+!+[]]))[(!![] + [])[+[]] + (!![] + [][(![] + [])[+[]] + ([![]] + [][
        ...
        []
    ])[+!+[] + [+[]]] + (![] + [])[!+[] + !+[]] + (!![] + [])[+[]] + (!![] + [])[!+[] + !+[] + !+[]] + (!![] + [])[+!+[]]])[+!+[] + [+[]]] + (!![] + [])[+!+[]]])[!+[] + !+[] + [+[]]]](!+[] + !+[] + [+[]]) + [!+[] + !+[] + !+[] + !+[] + !+[]] + [!+[] + !+[] + !+[] + !+[] + !+[] + !+[] + !+[] + !+[] + !+[]] + _b + _0x9ba7[10] + _a + _0x9ba7[11]
}

function decode_xstr(str) {
    var s = ''
    str.substring(1).split('\\').forEach(function(tmp) {
        s += String.fromCharCode(parseInt(tmp.replace('x', ''), 16));
    })
    return s;
}
module.exports = { sign, decode_xstr }